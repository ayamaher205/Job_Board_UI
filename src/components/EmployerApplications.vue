      ...
      <div v-for="application in post.applications" :key="application.id" class="col-span-3">
        <div class="relative max-w-sm">
          ...
          <div class="relative h-full p-3 bg-white border-2 border-green-500 rounded-lg">
            ...
            <div class="px-2 pt-2">
              <h3 class="text-sm font-medium text-green-800">Candiate Email</h3>
              <div class="flex space-x-2">
                ...
                <span class="text-sm text-gray-500">{{ application.app_email }}</span>
              </div>
            </div>

            <div class="px-2 pt-2">
              <h3 class="text-sm font-medium text-green-800">Candiate Phone</h3>
              <div class="flex space-x-2">
                <div class="flex justify-center items-center rounded-full bg-green-100 h-5 w-5"><svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
                    class="h-3 w-3 flex-shrink-0 text-green-500">
                ...
                <span class="text-sm text-gray-500">{{ application.app_phone }}</span>
              </div>
            </div>
            <div class="px-2 pt-2">
              <button type="button"
