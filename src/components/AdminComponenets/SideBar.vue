<template>
  <div class="flex flex-row">
    <div
      class="flex flex-col items-center w-40 h-full overflow-hidden text-dark-400 bg-white border border-gray-700 rounded-tr-2xl">
      <div class="flex flex-col items-center my-6 -mx-2">
        <img class="object-cover w-24 h-24 mx-2 rounded-full"
        :src="'http://127.0.0.1:8000/images/users/' + loggedadmin.user.image" alt="avatar" />
      ...
      <div class="w-full px-2">
        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          ...
          <router-link to="/admin/candidates"
            class="flex items-center w-full h-10 px-2 mt-2 rounded hover:bg-green-900 text-green-700 hover:text-green-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
          ...
          <router-link to="/admin/employers"
            class="flex items-center w-full h-10 px-2 mt-2 rounded hover:bg-green-900 text-green-700 hover:text-green-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
              <path
          ...
          <router-link to="/admin/posts"
            class="flex items-center w-full h-10 px-2 mt-2 rounded hover:bg-green-900 text-green-700 hover:text-100">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
              <path fill-rule="evenodd"
    ...
    <div class="flex flex-col items-center h-75 w-100 overflow-hidden text-dark-400 bg-gray-100 p-5">
      <router-view />
    </div>
  </div>
</template>
...
import { getUser } from '@/services/Admin.js'
export default {
  mounted(){
    this.fetchUser();
  },
