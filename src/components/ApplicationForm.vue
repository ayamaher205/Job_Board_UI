      ...
      <form class="w-full">
        <FormElements>
          ...
          <div class="text-xl mb-4 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">Basic data</div>
          </div>
          ...
          >
            ...
            >
              ...
              <div class="text-gray-500 text-sm italic dark:text-dark-400">{{ companyAddress }}</div>
            </CheckboxElement>
          </GroupElement>
          ...
          <div class="text-xl mb-4 mt-8 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">Schedule</div>
          </div>
          ...
          <div class="text-xl mb-4 mt-8 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">Requirements</div>
          </div>
          ...
          <div class="text-xl mb-4 mt-8 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">Job description</div>
          </div>
          ...
          <div class="text-xl mb-4 mt-8 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">How to apply</div>
          </div>
          ...
          <div class="text-xl mb-4 mt-8 col-span-12">
            <div class="border-b border-gray-300 pb-2 dark:border-dark-600">Pictures and videos</div>
          </div>
          ...
          <div class="col-span-12">
            <div class="border-t border-gray-300 pt-10 mt-6 dark:border-dark-600"></div>
          </div>
