      ...
      <div class=" my-4 rounded-lg p-10  max-w-xl shadow-box-circle bg-[#fafafae5] dark:bg-dark-1000 animate__animated animate__bounceIn">
        <form class="w-full" @submit.prevent="submitApplication">
          ...
          <div class="mb-4">
            ...
            <input type="email" v-model="formData.app_email" class="mt-1 block w-full rounded-md border-black border-t-0 border-l-0  focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 outline-none px-4 py-2" placeholder="Enter your email" required>
          ...
          <div class="mb-4">
            ...
            <input type="text" v-model="formData.app_phone" class="mt-1 block w-full rounded-md border-black border-t-0 border-l-0  focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 outline-none px-4 py-2" placeholder="Enter your phone" required>
